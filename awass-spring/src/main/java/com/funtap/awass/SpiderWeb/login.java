...
public class login {
    ...
    public boolean check_login(String html) throws IOException {
        ...
        Login = List.of(html.split("\n"));
        for(Object x : Login){
            if(x.toString().toLowerCase(Locale.ROOT).contains("login")
                    ||x.toString().toLowerCase(Locale.ROOT).contains("dang nhap")
                    ||x.toString().toLowerCase(Locale.ROOT).contains("dang_nhap")
                    ||x.toString().toLowerCase(Locale.ROOT).contains("singin")
                    ||x.toString().toLowerCase(Locale.ROOT).contains("sing_in")
            ){
                return true;
            }
        }
    ...
    private void DetectFormLogin(String html){

        Method method = new Method();
        String form =  method.GetFormString(html);
    ...
    private List<String> get_name_param(String html) throws IOException {
