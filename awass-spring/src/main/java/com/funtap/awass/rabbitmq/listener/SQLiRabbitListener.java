...
@Configuration
public class SQLiRabbitListener {
    @Autowired
    Gson gson;


    @RabbitListener(queues = SQLiRabbitConfiguration.QUEUE_SQLi,concurrency = "10")
...
//            //done sub to
            ...
            if(check) {
                ...
                reportScan.setResult("SQL Injection");
